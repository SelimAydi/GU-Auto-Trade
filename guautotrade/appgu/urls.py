...
urlpatterns = [
    ...
    path('portal/addeventpost/', views.addeventpost, name='eventpost'),
    path('portal/addmapdealer/', views.addmapdealer, name='mapdealer'),
    ...
    path('api/events/', views.eventsAPI, name='eventsAPI'),
    path('api/mapdealers/', views.mapdealersAPI, name='mapdealersAPI'),
